...
def print_chunks(chunks):
	...
	for chunk in chunks:
		if (chunk[0] == 'Vehicle'):
			if chunk[2][0]>0:
				output = output + 'You travelled by transport for {} hour, {} minutes and {} seconds\n'.format(chunk[2][0],chunk[2][1],chunk[2][2])
			else:
				output = output + 'You travelled by transport for {} minutes and {} seconds\n'.format(chunk[2][1],chunk[2][2])
		elif (chunk[0] == 'Walking'):
			if chunk[2][0]>0:
				output = output + 'You walked for {} hour, {} minutes and {} seconds\n'.format(chunk[2][0],chunk[2][1],chunk[2][2])
			else:
				output = output + 'You walked for {} minutes and {} seconds\n'.format(chunk[2][1],chunk[2][2])
		elif (chunk[0] == 'Still'):
			if chunk[2][0]>0:
				output = output + 'You rested for {} hour, {} minutes and {} seconds\n'.format(chunk[2][0],chunk[2][1],chunk[2][2])
			else:
				output = output + 'You rested for {} minutes and {} seconds\n'.format(chunk[2][1],chunk[2][2])
	return output
